...
| [Installing Windows 11 on Unsupported Hardware via VM](https://github.com/NaradaOates/linux-notes/blob/main/windows11-vm.md) | Using a virtual machine to run Windows 11 on a device that does not meet the official system requirements | `Windows` `Virtualisation` `VM` |
...
|---|---|---|
|[CPUID Supply Chain Attack](https://github.com/NaradaOates/cybersecurity-breakdowns/blob/main/incidents/cpuid-stx-rat-2026/breakdown.md)| STX RAT Incident Breakdown | `Malware` `RAT` `Threat Analysis` |
